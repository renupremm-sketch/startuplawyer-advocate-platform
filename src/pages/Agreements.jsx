                    ...
                    <div className="paper" style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
                        ...
                        <div style={{ marginTop: '2rem', padding: '1rem', backgroundColor: '#fffbeb', borderRadius: '8px', borderLeft: '4px solid #fbbf24' }}>
                            <p style={{ margin: 0, fontSize: '0.9rem', color: '#92400e' }}>
                                💡 <strong>Legal Note:</strong> This document has been generated based on your inputs. Please review carefully and consult with a qualified legal professional before execution. Ensure all placeholders are filled with accurate information.
                            </p>
                        </div>
                    </div>
                </div>
